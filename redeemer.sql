...
INSERT INTO pastors (pastor_first_name, pastor_last_name, spouse, pastor_story, spouse_story, image_url, family_marriage, prayer_needs) VALUES (
  ...
  'Banasing',
  'Jackie',
  'Raised in Christian family; passion for children & teaching; desired to be a pastor’s wife; attended Bible school with focus on children.ICM – educates parents & training of teachers; development & establish pre- schools (95 currently). Motivation is to serve; investing what you have in others; understanding challenge of pastors & pastor’s wives',
